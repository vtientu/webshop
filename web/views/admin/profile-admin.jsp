                                        ...
                                        <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380">
                                            <ul class="timeline">
                                                ...
                                                <li>
                                                    <div class="timeline-panel">
                                                        <div class="media mr-2">
                                                            <img alt="image" width="50" src="adminFE/img/avatar/1.jpg">
                                                        </div>
                                                        <div class="media-body">
                                                            <h6 class="mb-1">Dr sultads Send you Photo</h6>
                                                            <small class="d-block">29 July 2020 - 02:26 PM</small>
            ...
            <div class="content-body">
                <div class="container-fluid">
                    <div class="card card-outline-secondary">
                        ...
                        <div class="card-body">
                            <form action="adminProfile" method="post" class="form" role="form" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <div class="profile">
                                    ...
                                    <div class="overlay">
                                        <input id="imgInp" name="avatar" type="file" value=""  disabled>
                                        <p>Change Picture</p>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <select id="gender" id="user_time_zone" class="form-control" name="gender" disabled>
