<%-- 
    ...
    Created on : Nov 2, 2022, 8:52:59 PM
    Author     : Dell
--%>
                            ...
                            <div class="col-xl-12 col-lg-6 col-md-12">
                                <form action="addCategory" method="post">
                                    <div class="form-group">
                                        ...
                                        <input id="categoryName" name="categoryName" type="text" class="form-control validate"
                                               required />
                                    </div>

                                    <div class="form-group">
                                        <label for="describe">Describe
                                        </label>
                                        <textarea id="editor1" name="describe" rows="5" cols="10" class="form-control validate"></textarea>
                                    </div>
                                    <div class="col-12">
