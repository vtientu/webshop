<%-- 
    Document   : checkout
    Created on : Oct 21, 2022, 11:26:08 PM
    Author     : Dell
--%>
...
<html lang="en" dir="ltr">
    ...
    <head>
        ...
        <link rel="shortcut icon" type="image/png" href="userFE/images/logos/Logo-D.png">
        <link rel="icon" type="image/png" href="images/favicon.png"><!-- fonts -->
        <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto:400,400i,500,500i,700,700i"><!-- css -->
        <link rel="stylesheet" href="userFE/vendor/bootstrap-4.2.1/css/bootstrap.min.css">
        <link rel="stylesheet" href="userFE/endor/owl-carousel-2.3.4/assets/owl.carousel.min.css">
                                                ...
                                                <div class="dropcart__products-list">
                                                    <c:forEach items="${cart.items}" var="i">
                                                        <div class="dropcart__product">
                                                            ...
                                                            <a href="checkout?action=delete&id=${i.product.productID}"><button type="button"
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6"><label for="checkout-first-name">First
                                                        Name</label> <input type="text" class="form-control" name="firstName"
                                                                        id="firstName" value="${account.pro.firstName}" required></div>
                                                <div class="form-group col-md-6"><label for="checkout-last-name">Last
                                                        Name</label> <input type="text" class="form-control" name="lastName"
                                                                        id="checkout-last-name" value="${account.pro.lastName}" required></div>
                                            </div>
                                            <div class="form-group"><label for="checkout-company-name">Country</label>
                                                <input type="text" class="form-control" name="country" id="checkout-company-name" value="${account.pro.country}" required>
                                            </div>
                                            <div class="form-group"><label for="checkout-country">Address</label>
                                                <input type="text"
                                                       class="form-control" id="checkout-company-name" value="${account.pro.address}" name="address"></div>                               
                                            <div class="form-group"><label for="checkout-address">Phone
                                                </label> <input type="text" class="form-control" id="checkout-address" value="${account.pro.phone}" required name="phone"></div>


                                            <div class="form-group"><label for="checkout-email">Email
                                                    address</label> <input type="text" class="form-control"
                                                                       id="checkout-email" value="${account.email}" name="email" required></div>

                                        </form>
                                    </div>
                                    <div class="card-divider"></div>
                                    <div class="card-body">
                                        <h3 class="card-title">Shipping Note</h3>
                                        ...
                                        <div class="checkout__agree form-group">
                                            <div class="form-check"><span class="form-check-input input-check"><span
                                                        class="input-check__body"><input class="input-check__input"
                                                                                     type="checkbox" id="checkout-terms" required> <span
                                                                                     class="input-check__box"></span> <svg class="input-check__icon"
                                                                                     width="9px" height="7px">
                                                        <use xlink:href="userFE/images/sprite.svg#check-9x7"></use>
                                                        </svg> </span></span><label class="form-check-label"
                                                                            for="checkout-terms">I have read and agree to the website</label></div>
