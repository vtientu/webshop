                ...
                <div class="container-fluid">
                    <div class="page-titles">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="productList">Product List</a></li>
                        </ol>
                    </div>
                    <div class="row">
                        <div class="col-12">
                                        ...
                                        <table id="example3" class="display min-w850">
                                            ...
                                            <tbody>
                                                <c:forEach items="${requestScope.listProduct}" var="lp">
                                                    <tr>
                                                        <td>${lp.productID}</td>
                                                        <td> <img src="${lp.image}" width="100px" alt="alt"/></td>
                                                        <td>${lp.productName}</td>
                                                        <td>${lp.getPriceFormat()} VND</td>
                                                        <td>${lp.quantity}</td>
                                                        <td>${lp.getDate()}</td>
                                                        <td>
                                                            <div class="d-flex">
                                                                <a href="productDetail?id=${lp.productID}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                                                                <a href="deleteProduct?id=${lp.productID}" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
