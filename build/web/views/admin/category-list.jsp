<%-- 
    ...
    Created on : Oct 12, 2022, 8:29:19 PM
    Author     : Dell
--%>
                ...
                <div class="container-fluid">
                    <div class="page-titles">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="categoryList">Category List</a></li>
                        </ol>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <h4 class="card-title">
                                        <a class="active" href="addCategory"> Add Category</a>
                                    </h4>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example3" class="display min-w850">
                                            ...
                                            <tbody>
                                                <c:forEach items="${category}" var="lc">
                                                    <tr>
                                                        <td>${lc.categoryID}</td>
