<%-- 
    Document   : customer
    Created on : Oct 30, 2022, 1:47:32 AM
    Author     : Dell
--%>
                ...
                <div class="container-fluid">
                    <div class="page-titles">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="producerList">Producer List</a></li>
                        </ol>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <h4 class="card-title">
                                        <a class="active" href="addProducer"> Add Producer</a>
                                    </h4>
                                </div>
                                <div class="card-body">
                                            ...
                                            <tbody>
                                                <c:forEach items="${customer}" var="c">
                                                    <tr class="btn-reveal-trigger">
                                                        ...
                                                        <td class="py-3">
                                                            <a href="#">
                                                                <div class="media d-flex align-items-center">                                           
                                                                    <div class="media-body">
                                                                        <h5 class="mb-0 fs--1">${c.userName}</h5>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                        </td>
                                                        <td class="py-2"><a
                                                                >${c.email}</a></td>
                                                        <td class="py-2"> <a>${c.pro.country}</a></td>
                                                        <td class="py-2 pl-5 wspace-no">${c.pro.getDate()}</td>
                                                        <td class="py-2">${c.pro.phone}</td>
                                                        <td>${c.role}</td>
                                                        <td class="py-2">
                                                            <div class="dropdown"><button class="btn btn-primary tp-btn-light sharp" type="button" data-toggle="dropdown"><span class="fs--1"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18px" height="18px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"></rect><circle fill="#000000" cx="5" cy="12" r="2"></circle><circle fill="#000000" cx="12" cy="12" r="2"></circle><circle fill="#000000" cx="19" cy="12" r="2"></circle></g></svg></span></button>
                                                                <div class="dropdown-menu dropdown-menu-right border py-0">
                                                                    <div class="py-2"><a class="dropdown-item"  href="#!">Change Role</a></div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
