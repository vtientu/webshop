<%-- 
    ...
    Created on : Oct 31, 2022, 9:54:53 PM
    Author     : Dell
--%>
...
<html lang="en">
    ...
    <body>
            ...
            <div class="content-body">
                <div class="container-fluid">                   
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div style="text-align: center; margin-top: 10px"> Time: <strong>${list.get(0).order.getDate()}</strong></div>
                                <div class="card-body">
                                    <div class="row mb-5">
                                        <div class="mt-4 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                            <h6>From:</h6>
                                            <div> <strong>Shop: Đồ Điện Dân Dụng</strong> </div>
                                            <div>Name: Nguyễn Mạnh Đức</div>
                                            <div> Address: Đông Anh - Hà Nội</div>
                                            <div>Email: duc96989@gmail.com</div>
                                            <div>Phone: (+84) 97-230-7529</div>
                                        </div>
                                        <div class="mt-4 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                            <h6>To:</h6>
                                            <div> <strong>User</strong> </div>
                                            <div>Name: ${list.get(0).order.account.pro.fullName}</div>
                                            <div>Address: ${list.get(0).order.account.pro.address}</div>
                                            <div>Email: ${list.get(0).order.account.email}</div>
                                            <div>Phone: ${list.get(0).order.account.pro.phone}</div>
                                        </div>                                      
                                    </div>
                                            ...
                                            <tbody>
                                                ...
                                                <c:forEach items="${list}" var="o">
                                                    <tr>
                                                        ...
                                                        <td class="left"><img src="${o.product.image}" width="80px" height="80px"/></td>
                                                        <td class="left strong">${o.product.productName}</td>                                                        
                                                        <td class="right">${o.product.getPriceFormat()} VND</td>
                                                        <td class="center">${o.quantity}</td>
                                                        <td class="right">${o.getPriceFormat()} VND</td>
                                                    </tr>
                                            ...
                                            <table class="table table-clear">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="right">${list.get(0).order.getPriceFormat()} VND</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="right"><strong>${list.get(0).order.getPriceFormat()} VND</strong><br>
                                                        </td>
                                                    </tr>
        ...
        <script src="adminFE/vendor/highlightjs/highlight.pack.min.js"></script>
    </body>
</html>
