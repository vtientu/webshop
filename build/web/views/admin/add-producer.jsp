<%-- 
    ...
    Created on : Nov 2, 2022, 10:08:09 PM
    Author     : Dell
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <script src="adminFE/ckeditor/ckeditor.js"></script>
                            ...
                            <div class="col-xl-12 col-lg-6 col-md-12">
                                <form action="addProducer" method="post">
                                    <div class="form-group">
                                        <label for="producerName">Producer Name
                                        </label>
                                        <input id="categoryName" name="producerName" type="text" class="form-control validate"
                                               required />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="editor1" name="country" rows="5" cols="10" class="form-control validate"></textarea>
                                    </div>
                                    <div class="col-12">
