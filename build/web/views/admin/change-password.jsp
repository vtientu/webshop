<%-- 
    ...
    Created on : Oct 19, 2022, 1:13:32 PM
    Author     : Dell
--%>
        ...
        <div id="main-wrapper">
            ...
            <div class="content-body">
                <div class="container-fluid">
                    <div class="card card-outline-secondary" style="margin-top: 5%; ">
                        <div class="card-header">
                            <h3 class="mb-0">Change Password</h3>
                        </div>
                        <div class="card-body">
                            <form action="changePassword" method="post" class="form" role="form" autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <h5 id="showErrorOld2" hidden>Mật khẩu mới không được giống mật khẩu cũ</h5>
                                ...
                                <div class="form-group">
                                    ...
                                    <h5 id="showErrorOld3" hidden>Mật khẩu phải giống mật khẩu vừa thay đổi</h5>
                                </div>
