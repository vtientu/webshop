<%-- 
    ...
    Created on : Oct 24, 2022, 3:33:57 PM
    Author     : Dell
--%>
...
<html>
    ...
    <body>
                                                ...
                                                <div class="dropcart__products-list">
                                                    <c:forEach items="${cart.items}" var="i">
                                                        <div class="dropcart__product">
                                                            ...
                                                            <a href="changePass?action=delete&id=${i.product.productID}"><button type="button"
        ...
        <div class="card card-outline-secondary" style="margin: 10% 20%">
            <div class="card-header">
                <h3 class="mb-0">Change Password</h3>
            </div>
            <div class="card-body">
                <form action="changePass" method="post" class="form" role="form" autocomplete="off">
                    <input type="text" id="password" value="${account.password}" hidden>
                    <div class="form-group">
                        <label for="inputPasswordOld">Old Password</label>
                        <input onchange="oldPass()" name="oldpass" type="password" class="form-control" id="oldpass" required=""><br/>
                        <h5 id="showErrorOld" hidden style="color: red">Mật khẩu cũ không đúng</h5>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input onchange="newPass()" name="newpass" type="password" class="form-control" id="newpass" required="">
                        <h5 id="showErrorOld2" hidden style="color: red">Mật khẩu mới không được giống mật khẩu cũ</h5>

                    </div>

                    <div class="form-group">
                        <label for="inputPasswordNewVerify">Verify</label>
                        <input onchange="rePass()" name="repass" type="password" class="form-control" id="repass" required=""> 
                        <h5 id="showErrorOld3" hidden style="color: red">Mật khẩu mới phải giống mật khẩu cũ</h5>
                    </div>

                    <div class="form-group">
                        <button type="submit" onclick="return checkChangePass()" class="btn btn-success btn-lg float-right">Save</button>
                    </div>
                </form>
            </div>
        </div>
