<%-- 
    Document   : cart
    Created on : Oct 22, 2022, 10:51:28 PM
    Author     : Dell
--%>
                                                ...
                                                <div class="dropcart__products-list">
                                                    <c:forEach items="${cart.items}" var="i">
                                                        <div class="dropcart__product">
                                                            ...
                                                            <a href="cart?action=delete&id=${i.product.productID}"><button type="button"
                    ...
                    <table class="cart__table cart-table">
                        ...
                        <tbody class="cart-table__body">
                            ...
                            <form action="process" method="post">
                                <tr class="cart-table__row">
                                    <td class="cart-table__column cart-table__column--image"><a href="product?id=${i.product.productID}"><img
                                                src="${i.product.image}" alt=""></a></td>
                                    <td class="cart-table__column cart-table__column--product"><a href="product?id=${i.product.productID}"
                                                                                                  class="cart-table__product-name">${i.product.productName}</a>
                                        <ul class="cart-table__options">
                                            <li>Category: ${i.product.cate.categoryName}</li>
                                            <li>Producer: ${i.product.prod.producerName}</li>
                                        </ul>
                                    </td>
                                    <td class="cart-table__column cart-table__column--price" data-title="Price">${i.priceFormat}</td>
                                    <td class="cart-table__column cart-table__column--quantity" data-title="Quantity">
                                        <div class="input-number"><input class="form-control input-number__input"
                                                                         type="number" name="quantity"  value="${i.quantity}" onchange="this.form.submit()">
                                            <input type="text" name="id" value="${i.product.productID}" hidden>
                                            <div class="input-number__add"></div>
                                            <div class="input-number__sub"></div>
                                        </div>
                                    </td>
                                    <td class="cart-table__column cart-table__column--total" data-title="Total">${i.totalMoneyFormat}
                                    </td>
                                    <td class="cart-table__column cart-table__column--remove">
                                        <a  href="process?action=delete&id=${i.product.productID}"><button type="button"
                                                                                                           class="btn btn-light btn-sm btn-svg-icon"><svg width="12px" height="12px">
                                                <use xlink:href="userFE/images/sprite.svg#cross-12"></use>
                                                </svg></button></a></td>                                          
                                </tr>
                            </form>
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="cart__totals">
                                        ...
                                        <tbody class="cart__totals-body">
                                            <tr>
                                                <th>Shipping</th>
                                                <td>0 đ<div class="cart__calc-shipping"></div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Tax</th>
