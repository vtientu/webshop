<%-- 
    Document   : login
    Created on : Oct 8, 2022, 6:45:56 PM
    Author     : Dell
--%>
                                                ...
                                                <div class="dropcart__products-list">
                                                    <c:forEach items="${cart.items}" var="i">
                                                        <div class="dropcart__product">
                                                            ...
                                                            <a href="userLogin?action=delete&id=${i.product.productID}"><button type="button"
                            ...
                            <div class="card flex-grow-1 mb-md-0">
                                <div class="card-body">
                                    ...
                                    <form action="userLogin" method="post">
                                        ...
                                        <div class="form-group"><label>Mật khẩu"</label> <input type="password" name="password"
                                        ...
                                        <div class="form-group">
                                            <div class="form-check"><span class="form-check-input input-check"><span
                                                        ...
                                                        <use xlink:href="images/sprite.svg#check-9x7"></use>
                                                                            ...
                                                                            for="login-remember">Ghi nhớ mật khẩu</label></div>
                                        </div><button type="submit" class="btn btn-primary mt-4">Đăng nhập</button>
                                        <button type="button" class="btn btn-primary mt-4" onclick="dangky()">Đăng
                                            ký</button>
                                    </form>
                                </div>
                            </div>
