...
public class UserHome extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if (action != null && action.equalsIgnoreCase("delete")) {
            ...
            request.setAttribute("ProducerofRangDong", new ProductDAO().getProductbyProducerID(1));
            request.setAttribute("ProducerofTranPhu", new ProductDAO().getProductbyProducerID(2));
            request.setAttribute("Productnew", new ProductDAO().getNewProduct());
...
//        for (Product product : new ProductDAO().getProductbyProducerID(2)) {
